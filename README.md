# _[C# Triangle Tracker](https://github.com/TSiu88/triangle-tracker-csharp)_

#### _Check if a Triangle in C# with Tests, 03.2.2020_

#### By _**Tiffany Siu and Adela Darmansyah**_

[![Project Status: Inactive – The project has reached a stable, usable state but is no longer being actively developed; support/maintenance will be provided as time allows.](https://www.repostatus.org/badges/latest/inactive.svg)](https://www.repostatus.org/#inactive)
![LastCommit](https://img.shields.io/github/last-commit/tsiu88/triangle-tracker-csharp)
![Languages](https://img.shields.io/github/languages/top/tsiu88/triangle-tracker-csharp)
...
This console application was written for Epicodus Intro to Programming and C#/React course.  It practices using MSTest with C# and checks what kind of triangle is made from the lengths of 3 sides.
...
2. Clone the [repository](https://github.com/TSiu88/triangle-tracker-csharp.git) from my [GitHub page](https://github.com/TSiu88)
